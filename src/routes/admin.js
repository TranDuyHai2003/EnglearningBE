...
router.post("/approvals/courses/:id/approve", minRole("support_admin"), approveCourse);
router.post("/approvals/courses/:id/reject", minRole("support_admin"), rejectCourse);
router.post("/approvals/lessons/:id/approve", minRole("support_admin"), approveLesson);
router.post("/approvals/lessons/:id/reject", minRole("support_admin"), rejectLesson);
